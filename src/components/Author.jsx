...
const Author = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center  p-6 shadow-md rounded-xl sm:px-12 bg-gray-900 dark:bg-gray-50 text-gray-100 dark:text-gray-800">
      <img
        src={profile_image}
        alt=""
